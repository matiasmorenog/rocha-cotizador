...
| `npm run dev:wipe-customers` | Wipe customer PII on Neon **development** only; seeds fictitious clients (`CONFIRM_DEV_WIPE_CUSTOMERS=1`, `SEED_TARGET=development`; refuses production/main) |
